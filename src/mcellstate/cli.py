...
from . import Optimizer, PartitionState, make_prior
...
def build_parser() -> argparse.ArgumentParser:
    ...
    fit.add_argument(
        ...
        choices=FIT_PRESETS,
        default="balanced",
        help="balanced is the default; gpu reduces CPU-heavy refinement; quality is more exhaustive; benchmark matches comparison runs.",
    )
    fit.add_argument(
        "--optimizer-mode",
